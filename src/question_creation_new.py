...
def build_master_prompt(entries):
    prompt_intro = """# Cybersecurity Question Generator
                        ...
                        Act as you do not know anything but the dataset provided in the prompt. You'll need to read it and generate MAX 10 high-quality multiple-choice questions
                        ...
                        ### Content Focus:
                        - **Combinatory**: Combine precise details across multiple techniques/procedures to crate a question and options
                        ...
                        ### Quality Standards:
                        - Can also use "All of the above" or "None of the above" as options
                        ...
                        - Provide MAX 5 multiple-choice questions in the following format:
                        [
                            {
                                ...
                                "Explanation": {
                                    "A": "Explanation for why A is correct/incorrect",
                                    "B": "Explanation for why B is correct/incorrect",
                                    "C": "Explanation for why C is correct/incorrect",
                                    "D": "Explanation for why D is correct/incorrect"
                                },
...
if __name__ == "__main__":
    ...
    for chunk in chunks:
        with open(chunk, "r", encoding="utf-8") as f:
            ...
            output_file = f"questions/mcqs_{chunk.split('/')[-1]}"
